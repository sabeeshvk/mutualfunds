...
do
 ...
 ccmd="curl  -o $prev_year-$prev_month_num  --request GET http://portal.amfiindia.com/DownloadNAVHistoryReport_Po.aspx?frmdt=01-$prev_month-$prev_year&todt=01-$cur_month-$cur_year"
